...
> 이 글은 서비스 종료된 이전 재직사의 기술 블로그에 발행 전 사내 검증을 거쳐 공개되었던 본인 원고입니다. 학습 자산 보존 목적으로 일부 정보를 익명화하여 이관하였습니다.

## Overview

이번 글에서는 이전 재직사에서 동료들과 프로젝트를 진행하면서 Bootstrap-vue를 도입하게 된 경험을 공유하려 합니다.
...
어드민 내에서 Number Input이 사용되는 곳을 분석해보니 크게 두 가지 유형이었습니다.
...
함께 리뷰하고 피드백 주신 동료들께 감사드립니다. 덕분에 더 나은 컴포넌트를 만들 수 있었습니다.

---

원문은 회사 공식 기술 블로그에 발행되었으나 현재 서비스 종료되어 접근 불가합니다.
