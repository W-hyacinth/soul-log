...
- 기존 프로젝트에서 사용 중인 명령어와 동일(또는 유사)하게 유지합니다.
...
```javascript
// 기존 프로젝트 (vue-cli-service)
"scripts": {
    "http": "vue-cli-service serve --mode development --public 0.0.0.0 --no-lint --port 7001",
    "serve": "vue-cli-service serve --mode development --host local.dev --port 443 --https --no-lint",
...
"scripts": {
    ...
    "serve": "sudo vite --mode development --host local.dev --port 443",
